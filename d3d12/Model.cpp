...
void Model::InitCube(ID3D12Device* device,
  ...
  ColorPass::VertexData vertices[] = {
      // +x direction
      {{+1.0f, -1.0f, -1.0f}, {0.0f, 1.f / 3.f}, {1.f, 0.f, 0.f}},
      {{+1.0f, +1.0f, -1.0f}, {0.0f, 0.0f}, {1.f, 0.f, 0.f}},
      {{+1.0f, +1.0f, +1.0f}, {0.5f, 0.0f}, {1.f, 0.f, 0.f}},
      {{+1.0f, -1.0f, +1.0f}, {0.5f, 1.f / 3.f}, {1.f, 0.f, 0.f}},

      // -x direction
      {{-1.0f, -1.0f, +1.0f}, {0.5f, 0.0f}, {-1.f, 0.f, 0.f}},
      {{-1.0f, +1.0f, +1.0f}, {0.5f, 1.f / 3.f}, {-1.f, 0.f, 0.f}},
      {{-1.0f, +1.0f, -1.0f}, {1.0f, 1.f / 3.f}, {-1.f, 0.f, 0.f}},
      {{-1.0f, -1.0f, -1.0f}, {1.0f, 0.0f}, {-1.f, 0.f, 0.f}},

      // +y direction
      {{+1.0f, +1.0f, +1.0f}, {0.0f, 1.f / 3.f}, {0.f, 1.f, 0.f}},
      {{+1.0f, +1.0f, -1.0f}, {0.0f, 1.f / 3.f}, {0.f, 1.f, 0.f}},
      {{-1.0f, +1.0f, -1.0f}, {0.5f, 2.f / 3.f}, {0.f, 1.f, 0.f}},
      {{-1.0f, +1.0f, +1.0f}, {0.5f, 2.f / 3.f}, {0.f, 1.f, 0.f}},

      // -y direction
      {{+1.0f, -1.0f, +1.0f}, {0.5f, 2.f / 3.f}, {0.f, -1.f, 0.f}},
      {{+1.0f, -1.0f, -1.0f}, {0.5f, 1.f / 3.f}, {0.f, -1.f, 0.f}},
      {{-1.0f, -1.0f, -1.0f}, {1.0f, 1.f / 3.f}, {0.f, -1.f, 0.f}},
      {{-1.0f, -1.0f, +1.0f}, {1.0f, 2.f / 3.f}, {0.f, -1.f, 0.f}},

      // +z direction
      {{+1.0f, -1.0f, +1.0f}, {0.0f, 1.0f}, {0.f, 0.f, 1.f}},
      {{+1.0f, +1.0f, +1.0f}, {0.0f, 2.f / 3.f}, {0.f, 0.f, 1.f}},
      {{-1.0f, +1.0f, +1.0f}, {0.5f, 2.f / 3.f}, {0.f, 0.f, 1.f}},
      {{-1.0f, -1.0f, +1.0f}, {0.5f, 1.0f}, {0.f, 0.f, 1.f}},

      // -z direction
      {{-1.0f, -1.0f, -1.0f}, {0.5f, 1.0f}, {0.f, 0.f, -1.f}},
      {{-1.0f, +1.0f, -1.0f}, {0.5f, 2.f / 3.f}, {0.f, 0.f, -1.f}},
      {{+1.0f, +1.0f, -1.0f}, {1.0f, 2.f / 3.f}, {0.f, 0.f, -1.f}},
